...
<div class="bg-white">
    <div class="w-full mx-auto">
        ...
        <section class="relative h-[600px] lg:h-[500px] flex items-center justify-center text-center overflow-hidden">
            <div class="absolute inset-0 z-0 opacity-100">
                <img src="{{ asset('images/imga1.png') }}" alt="image"
                    class="w-full h-full md:h-[550px] lg:h-[800px] object-cover rounded-lg shadow-lg" />
            </div>

            <div class="relative z-10 text-center">
                <h1 class="lg:text-5xl font-bold mb-4 text-3xl">L’art sans limites</h1>
        ...
        <section class="space-y-12 mb-8 mt-4">
