        ...
        <div id="mobile-menu" class="mobile-menu md:hidden w-full">
            <nav class="mt-4">
                <ul class="flex flex-col space-y-3">
                    ...
                    <li><a href="#" class="block py-2 text-gray-600 hover:text-black">Artistes</a></li>
        ...
        <div class="hidden md:flex items-center justify-between w-full">
            <div class="flex items-center justify-between w-full">
                ...
                <div class="flex space-x-3">
                    ...
                    <a href="/login" class="text-white px-6 py-3 rounded-full bg-gradient-to-tr from-pink-500 to-purple-700">Se Connecter</a>
                    @endguest
                    @auth
                    <form action="/logout" method="POST">
                        @csrf
                        <button type="submit" class="text-white px-6 py-3 rounded-full bg-gradient-to-tr from-pink-500 to-purple-700">Se Déconnecter</button>
                    </form>
                    @endauth
                </div>
            </div>
